...
// 프로젝트에 준비된 컴포넌트들을 모아 보여주는 데모 페이지
// 기존엔 30개 가까운 컴포넌트가 한 화면에 전부 펼쳐져 있어서(스크롤만 몇 페이지) 원하는 걸
// 찾아 테스트하기 불편하다는 피드백을 받아, "공통 컴포넌트(base/)" / "커스텀 컴포넌트(custom·layout/)"
// 두 탭 + 아코디언(버튼 눌러야 펼쳐짐) 구조로 재구성함 — 필요한 것만 눌러서 빠르게 확인 가능
//
// 각 컴포넌트가 어떤 props를 받고 어떻게 동작하는지 확인하는 용도, 실제 로직 없이 임시 state만 사용
