  ...
  return (
    ...
    <div className="header">
      ...
      <div className="header__top">
        ...
        {current && total && (
          <span className="header__count">{current}/{total}</span>
        )}
      </div>
      ...
      <div className="header__row">
        ...
        <button className="header__back-btn" onClick={onBack} aria-label="뒤로가기">
          <ChevronLeft size={20} />
        </button>
        ...
        <img src="/icons/sprout.svg" alt="새싹" className="header__icon" />
      </div>
    </div>
  );
};
