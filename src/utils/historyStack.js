// 역할: 화면 이동 기록을 쌓아두는 순수 기록 장부. React Router의 navigate(-1)은 브라우저
//       히스토리를 다룰 뿐 "어디서 어떤 파라미터를 들고 왔는지"는 기억하지 못해서, 뒤로가기 시
//       파라미터를 유지하거나 이전 화면 정보를 참고하려면 별도 기록이 필요함. 화면을 다시 그릴
//       필요가 없는 값이라 useState 대신 모듈 스코프 배열로 관리
// 사용처: useNavigation.js
// 담당자:
